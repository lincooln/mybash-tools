...
подключать все сразу через главный файл .mybashrc, либо использовать по отдельности, подключая напрямую в свой .bashrc;
Таким образом достигается простота редактирования, расширяемость и переносимость между машинами.
...
├── myhelp.sh                      # Персональная справочная система
