mybash-tools
проект, полностью написанный ИИ (Qwen3-Max) в соавторстве с человеком.
...
mybash-tools — это набор модулей для оформления своего bash окружения. Созавая "уют" и индивидуальный внешний вид.
...
source ~/.bashrc
```
Либо скачайте всё однм архивом при помощи браузера и разархивируйте, например в домашнюю директорию.
перейдите в разархивированную директорию и запустите install.sh
следуйте подсказкам.
