...
## Лицензии шрифтов
Проект включает шрифт [Terminess Nerd Font](https://www.nerdfonts.com/), 
который является комбинацией:
- [Terminus Font](https://terminus-font.sourceforge.net/) (SIL Open Font License)
- [Nerd Fonts](https://github.com/ryanoasis/nerd-fonts) (MIT License)
Полные тексты лицензий доступны на соответствующих сайтах.
